	...
	"inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-[15px] text-sm font-medium transition-standard focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-ring disabled:opacity-80 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
	{
		variants: {
			variant: {
				...
				quantity:
					"bg-background/40 text-primary border border-primary hover:bg-primary hover:text-primary-foreground! hover:[&_span]:!text-primary-foreground hover:[&_svg]:!text-primary-foreground active:bg-primary active:text-primary-foreground! active:[&_span]:!text-primary-foreground active:[&_svg]:!text-primary-foreground disabled:cursor-not-allowed disabled:border-primary/30 disabled:bg-muted disabled:text-muted-foreground disabled:hover:bg-muted disabled:hover:text-muted-foreground! disabled:hover:[&_svg]:!text-muted-foreground disabled:active:bg-muted disabled:active:text-muted-foreground!",
				status:
